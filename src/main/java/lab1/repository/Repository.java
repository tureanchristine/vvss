...
public class Repository {
    ...
    public void addPatientToFile(Patient p) throws IOException        // save to file
    {
        try
        {
            FileWriter writer = new FileWriter(patients,true);
            writer.write(p.getName() + "," + p.getSSN() + "," + p.getAddress() + "," +p.getAddress()  + "," + p.getConsNum() + "\n");
            writer.close();
    ...
    public void addConsultationToFile(Consultation c) throws IOException        // save to file
    {
        try
        {
            FileWriter writer = new FileWriter(consultations,true);
